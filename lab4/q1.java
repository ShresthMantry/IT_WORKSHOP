        ...
        do {
            ...
            switch (choice) {
                case 1:
                    System.out.print("Enter Song ID: ");
                    songId = scanner.nextInt();
                    songs[search(songs,songId)].setDetails();
                    break;
                case 2:
                    System.out.print("Enter Song ID: ");
                    songId = scanner.nextInt();
                    songs[search(songs,songId)].getDetails(songId);
                    break;
                case 3:
                    System.out.print("Enter Song ID: ");
                    songId = scanner.nextInt();
                    songs[search(songs,songId)].play();
                    break;
                case 4:
                    System.out.print("Enter Song ID: ");
                    songId = scanner.nextInt();
                    songs[search(songs,songId)].addToPlaylist(songId);
                    break;
                case 5:
                    System.out.print("Enter Song ID: ");
                    songId = scanner.nextInt();
                    songs[search(songs,songId)].removeFromPlayList(songId);
                    break;
                case 6:
